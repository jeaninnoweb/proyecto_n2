...
function listar_ventastotales () {	
	$.getJSON("listar_ventastotales", function (data) {      
			...
			$.each(data, function (i, item) {	
				...
				$table_saletotal.row.add([item.id_venta,tcompro_pago,item.fecha_venta,item.nombres_persona,'DNI', item.dni_persona,item.nro_productos,item.total_venta,item.nombres_persona,
